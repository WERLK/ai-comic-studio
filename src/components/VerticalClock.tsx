  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col">
        <div className="font-display text-lg font-bold text-cyber-yellow tracking-wider">
          {year}-{month}-{day}
        </div>
        <div className="font-display text-lg font-bold text-cyber-pink tracking-wider">
